...
$routes->get('layanan-publik/ptsp/standar-pelayanan', 'Layananpublik::standarPelayanan');

// 1. Rute untuk menampilkan halaman utama (yang saat ini error)
$routes->get('layananpublik/standarPelayanan', 'Layananpublik::standarPelayanan');

// 2. Rute untuk menampilkan form tambah/edit
$routes->get('layananpublik/formStandarPelayanan/(:num?)', 'Layananpublik::formStandarPelayanan/$1');

// 3. Rute untuk MENYIMPAN data dari form
