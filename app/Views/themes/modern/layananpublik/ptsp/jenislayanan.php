...
<div class="card shadow-sm">
    <div class="card-header bg-light">
        <h4 class="mb-0">Pengaturan Halaman Jenis Layanan PTSP</h4>
    </div>
    <div class="card-body">
    <form method="POST" action="<?= site_url('layanan-publik/ptsp/jenis-layanan') ?>">
    </form>
            <?= csrf_field() ?>

            <div class="form-group">
                <label for="isi_halaman" class="font-weight-bold">Konten Halaman</label>
                <p class="text-muted"><small>Gunakan editor di bawah ini untuk menulis daftar layanan. Gunakan fitur "Heading" untuk membuat sub-judul dan "Numbered List" untuk daftar berurutan.</small></p>
