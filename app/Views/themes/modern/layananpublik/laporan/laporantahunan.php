...
<div class="card shadow-sm">
    <div class="card-header bg-light">
        <h4 class="mb-0">Pengaturan Halaman Laporan Tahunan</h4>
    </div>
    <div class="card-body">
        <form method="POST" action="<?= site_url('layananpublik/laporanTahunan') ?>" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="form-group">
                <label for="file_pdf" class="font-weight-bold">Ganti File PDF Laporan Tahunan</label>
