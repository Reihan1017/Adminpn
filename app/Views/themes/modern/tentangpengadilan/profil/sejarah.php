...
<div class="card shadow-sm">
    <div class="card-header bg-light">
        <h4 class="mb-0">Pengaturan Halaman Sejarah Pengadilan</h4>
    </div>
    <div class="card-body">
        <form method="POST" action="<?= site_url('tentangpengadilan/sejarah') ?>">
            <?= csrf_field() ?>

            <div class="form-group">
                <label for="isi_halaman" class="font-weight-bold">Konten Halaman</label>
                <p class="text-muted"><small>Gunakan editor di bawah ini untuk menulis dan memformat konten sejarah pengadilan. Perubahan akan disimpan saat Anda menekan tombol "Simpan Perubahan".</small></p>
...
<script>
  tinymce.init({
    ...
    height: 600, // Membuat editor lebih tinggi
    menubar: false, // Menyembunyikan menu bar untuk tampilan lebih simpel
    ...
    content_style: 'body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif; font-size: 16px; }' // Menyesuaikan font di dalam editor
  });
</script>