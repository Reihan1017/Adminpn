...
<div class="card shadow-sm">
    <div class="card-header bg-light">
        <h4 class="mb-0">Pengaturan Halaman Wilayah Yuridiksi</h4>
    </div>
    <div class="card-body">
        <form method="POST" action="<?= site_url('tentangpengadilan/wilayah') ?>">
            <?= csrf_field() ?>

            <div class="form-group">
                <label for="isi_halaman" class="font-weight-bold">Konten Halaman</label>
                <p class="text-muted"><small>Gunakan editor di bawah ini untuk menulis daftar wilayah yuridiksi. Gunakan fitur "Numbered List" pada editor untuk membuat daftar berurutan.</small></p>
